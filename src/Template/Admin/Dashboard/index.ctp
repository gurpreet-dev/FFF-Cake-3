...
<section class="content">
	<div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?php echo count($subscribed); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
                <span class="info-box-icon bg-green"><i class="fa fa-amazon"></i></span>
                <div class="info-box-content">
                    <span class="info-box-text">Products</span>
                    <span class="info-box-number"><?php echo count($products['GetMatchingProductResult']); ?></span>
                </div>
            </div>
        </div>
